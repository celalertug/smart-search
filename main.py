...
def main():
    parser = argparse.ArgumentParser(description="Search for words in files recursively with boolean expressions.")
    parser.add_argument("directory", help="Directory to search in")
    parser.add_argument("expression", help="Boolean expression to search for (e.g., '(word1 & word2) | word3')")
